...
public class GenericServiceAddressImpl implements GenericServiceAddress {
    ...
    @Override
    public DatabaseActionResponse simpleUpdate(DatabaseType databaseType) {
        long duration;

        final long startTime = System.nanoTime();

        final DatabaseActionResponse response = strategies.get(databaseType).simpleUpdate();
    ...
    @Override
    public DatabaseActionResponse simpleDelete(DatabaseType databaseType) {
        long duration;

        final long startTime = System.nanoTime();

        final DatabaseActionResponse response = strategies.get(databaseType).simpleDelete();
